...
static const uint8_t DEVICE_NAME[] = "BTN1_ID2";
static const Gap::Address_t BLE_NW_ADDR = {HOME_ID, 0x00, 0x00, 0xE1, 0x01, DEV_PROVISION_ID};
static const uint16_t SERVICE_UUID_LIST[] = {BUTTON1_SERVICE_UUID};
...
void BleConn::onInitComplete(BLE::InitializationCompleteCallbackContext *event)
{
    ...
    GattCharacteristic* charTable[] = {&this->buttonState};
    GattService service(BUTTON1_SERVICE_UUID, charTable, sizeof(charTable) / sizeof(GattCharacteristic *));
