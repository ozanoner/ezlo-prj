...
private:
    ...
    void on_init_complete(BLE::InitializationCompleteCallbackContext *event)
    {
        ...
        _event_queue.call(this, &GAPDevice::scan_mode_start);
    };
    ...
    void scan_mode_start() {
        ...
        _event_queue.call(this, &GAPDevice::scan2);
        _is_connecting = false;
    }
    ...
    void scan2() {
        ...
        error = _ble.gap().startScan(this, &GAPDevice::on_scan2);
    ...
    void scan()
    {
        ...
        error = _ble.gap().setScanParams(400, 400, 0, true);
        /*
    ...
    void demo_mode_end()
    {
        ...
        */
        ...
        if(_set_index>=SCAN_PARAM_SET_MAX)
            _set_index = 0;
